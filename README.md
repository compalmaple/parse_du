...
online tool => https://compalmaple.github.io/parse_du/index.html

## Example
```
Please paste the whole du_state_xxx.txt in the table below. And Click “Parse Txt”to obtain Throughput, BLER and MCS.
